 ...
 */
public class MinusDiTechIndicator extends TechnicalIndicator implements IMomentumType {

   private static final long serialVersionUID = 7829120622773633117L;

   public MinusDiTechIndicator() {
      super();
   }
      ...
      for (int i = 1; i < ticks.length - 1; i++) {
         ...
         if (i - smoothRatio + 1 < 1) {
            ...
            if (graphics != null) {
               ...
               Point newPt = plotter.plotScaleAt(diMinus, dt);
               if (oldPt != null) {
